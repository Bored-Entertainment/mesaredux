...
layout: default
title: "cookie policy"
header: "* MESλREDUX - COOKIE POLICY *"
scroller: true
wide: true
---
...
You have the right to decide whether to accept or reject cookies. You can control cookies through your browser settings. Essential cookies may be required for the site to function.
...
| Name     | Purpose                                                                 | Provider      | Service                                                                 | Type         |
|----------|-------------------------------------------------------------------------|---------------|-------------------------------------------------------------------------|--------------|
| `_ga_#`  | Used to distinguish individual users by means of designation of a randomly generated number as client identifier, which allows calculation of visits and sessions | .mesagrey.ca | Google Analytics [View Service Privacy Policy](https://business.safety.google/privacy/) | http_cookie  |
| `_ga`    | Records a particular ID used to come up with data about website usage by the user | .mesagrey.ca | Google Analytics [View Service Privacy Policy](https://business.safety.google/privacy/) | http_cookie  |

##### First Party Local Storage / Similar Technologies
...
Our Website uses Ruffle, a modern Flash emulator that does not support or create traditional Flash Cookies (also known as Local Shared Objects or LSOs).  
Ruffle runs Flash content in a secure, sandboxed environment and does not access legacy Flash storage features.  
As a result, no Flash Cookies are stored on your device.

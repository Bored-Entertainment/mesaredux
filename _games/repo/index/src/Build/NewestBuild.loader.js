function createUnityInstance(t, n, c) {
    ...
    return l.SystemInfo = function() {
        ...
        var d, l = {
            ...
            "NT 6.3": "8.1",
            "NT 10.0": "10"
        }[l] || l, h = ((h = document.createElement("canvas")) && (d = (f = h.getContext("webgl2")) ? 2 : 0,
        f || (f = h && h.getContext("webgl")) && (d = 1),
        f && (r = f.getExtension("WEBGL_debug_renderer_info") && f.getParameter(37446) || f.getParameter(7937))),
